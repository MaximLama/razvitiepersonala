BX.saleOrderAjax = { // bad solution, actually, a singleton at the page
	...
	addPropertyDesc: function(desc){
		console.log("scripts addPropertyDesc");
	...
	{
		console.log("scripts initDeferredControl");
		var ctx = this,
			k,
			row,
			input,
	...
	checkAbility: function(propId, ability){
		console.log("scripts checkAbility");
	...
	getInputByPropId: function(propId){
		console.log("scripts getInputByPropId");
	...
	getRowByPropId: function(propId){
		console.log("scripts getRowByPropId");
	...
	getAltLocPropByRealLocProp: function(propId){
		console.log("scripts getAltLocPropByRealLocProp");
	...
	toggleProperty: function(propId, way, dontModifyRow){
		console.log("scripts toggleProperty");
	...
	{
		console.log("scripts submitFormProxy");
		var propId = false;
		for(var k in this.properties){
	...
	getPreviousAdapterSelectedNode: function(control, adapter){
		console.log("scripts getPreviousAdapterSelectedNode");
	...
	{
		console.log("scripts getLocationsByZip");
