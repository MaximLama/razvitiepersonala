...
<div class="course-page__item" card-id=<?=$arItem["ID"]?>>
    <div class="course-page__img-box">
        <img src="<?=$arItem["PREVIEW_PICTURE"]["SRC"]?>" alt="<?=$arItem["PREVIEW_PICTURE"]["ALT"]?>">
    </div>
    <a href="<?=$arItem["DETAIL_PAGE_URL"]?>" class="course-page__text-block">
        <div class="course-page__item-title"><?=$arItem["PROPERTIES"]["NAZVANIE_KARTOCHKI"]["~VALUE"]["TEXT"]?></div>
        <div class="course-page__item-price"><?=$arItem["PROPERTIES"]["STOIMOST"]["VALUE"]?></div>
    </a>
    <a href="javascript:void(0)" class="course-page__item-btn">
