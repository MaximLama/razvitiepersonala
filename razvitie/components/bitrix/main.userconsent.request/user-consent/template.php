...
?>
<label data-bx-user-consent="<?=htmlspecialcharsbx($config)?>" class="calculate__label-checkbox label-checkbox check">
	<input type="checkbox" value="Y" <?=($arParams['IS_CHECKED'] ? 'checked' : '')?> name="<?=htmlspecialcharsbx($arParams['INPUT_NAME'])?>" class="calculate__checkbox">
